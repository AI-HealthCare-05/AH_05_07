...
SPEC = importlib.util.spec_from_file_location(
    "sk7_local_export", Path(__file__).resolve().parents[2] / "scripts/model/export_model_v2_browser.py"
)
...
def test_repository_output_is_rejected_before_artifact_access() -> None:
    with pytest.raises(ValueError, match="outside repository"):
        EXPORT.export(Path("does-not-exist.joblib"), EXPORT.REPO_ROOT / "web/public/models")
