...
import { generateSceneSource } from "./verify-scene-manifest.mjs";
...
const posters = evidence.posters.map(poster => ({ ...template, id: poster.id, revision: "clay-001", status: "review", delivery: poster.delivery,
