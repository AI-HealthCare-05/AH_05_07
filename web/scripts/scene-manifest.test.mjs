...
for (const source of ["web/src/components/scene/scene-stage.css", "web/scripts/scene-asset-inputs.mjs", "web/src/components/VisualStage.tsx", "web/src/ui/sceneRecipes.ts", "web/src/components/scene/disposeScene.ts"]) test(`poster capture pins ${source}`, () => {
