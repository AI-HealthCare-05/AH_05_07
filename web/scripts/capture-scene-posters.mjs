...
try {
  await build({ root: web, build: { outDir: temporary, emptyOutDir: true },
    define: { "import.meta.env.VITE_API_BASE_URL": JSON.stringify("http://e2e.invalid"), "import.meta.env.VITE_SK7_E2E_MODE": '"1"', "import.meta.env.VITE_SK7_SCENE_MODE": '"review"', "import.meta.env.VITE_SK7_COMPANION_MODE": '"review"', "import.meta.env.VITE_SK7_UI_MODE": '"legacy"' },
