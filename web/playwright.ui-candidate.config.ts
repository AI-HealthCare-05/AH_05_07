...
export default defineConfig({
  testDir: './e2e',
  testMatch: companionOff ? ['ui-candidate.cases.ts', 'journey-candidate.cases.ts', 'challenge-daily.cases.ts', 'living-cycle.cases.ts'] : ['ui-candidate.cases.ts', 'journey-candidate.cases.ts', 'challenge-daily.cases.ts', 'living-cycle.cases.ts', 'recap-candidate.cases.ts', 'companion-production.spec.ts', 'session-privacy-boundary.spec.ts', 'model-v2-user-input-flow.spec.ts', 'model-v2-result-state.spec.ts'],
