...
export default defineConfig({
  testDir: './e2e',
  testMatch: companionOff ? ['shared-ui-foundation.spec.ts', 'ui-candidate.cases.ts', 'journey-candidate.cases.ts', 'challenge-daily.cases.ts', 'living-cycle.cases.ts', 'presence-host-foundation.spec.ts'] : ['shared-ui-foundation.spec.ts', 'ui-candidate.cases.ts', 'journey-candidate.cases.ts', 'challenge-daily.cases.ts', 'living-cycle.cases.ts', 'presence-host-foundation.spec.ts', 'recap-candidate.cases.ts', 'companion-production.spec.ts', 'session-privacy-boundary.spec.ts', 'model-v2-user-input-flow.spec.ts', 'model-v2-result-state.spec.ts', 'showcase-cinema.spec.ts'],
