...
test('living week uses Seoul dates and date-only landmarks with mixed facts and legacy kept apart', async ({ page }) => {
  ...
  await expect(dateButtons.nth(0)).toHaveAccessibleName('토 9/5 · 2026년 9월 5일 · 정자 · 혈압 관찰 0건, 챌린지 참여 기록 없음');
  await expect(dateButtons.nth(1)).toHaveAccessibleName('일 9/6 · 2026년 9월 6일 · 노을 전망대 · 혈압 관찰 0건, 챌린지 참여 기록 없음');
  await expect(dateButtons.nth(2)).toHaveAccessibleName('월 9/7 · 2026년 9월 7일 · 정원 대문 · 혈압 관찰 0건, 챌린지 참여 기록 없음');
  await expect(dateButtons.nth(3)).toHaveAccessibleName('화 9/8 · 2026년 9월 8일 · 허브 정원 · 혈압 관찰 0건, 챌린지 참여 기록 없음');
  await expect(dateButtons.nth(4)).toHaveAccessibleName('수 9/9 · 2026년 9월 9일 · 나무 그늘과 벤치 · 혈압 관찰 0건, 챌린지 참여 기록 없음');
  await expect(dateButtons.nth(5)).toHaveAccessibleName('목 9/10 · 2026년 9월 10일 · 나무다리 · 혈압 관찰 0건, 챌린지 참여 기록 없음');
  await expect(dateButtons.nth(6)).toHaveAccessibleName('오늘 9/11 · 2026년 9월 11일, 오늘 · 책 읽는 쉼터 · 혈압 관찰 1건, 챌린지 참여 혼합');
