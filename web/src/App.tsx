    ...
    <main className="page-shell" data-evidence-fixture={fixture?.name}>
      ...
      {(windowState === "ready" || windowState === "refreshing" || windowState === "refresh-error") && (
        <>
          ...
          <section className="work-lanes" aria-label="오늘의 기록 작업">
