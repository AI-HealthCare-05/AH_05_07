...
function App() {
  ...
  const companionContext: CompanionSelectionContext | undefined = activeScreen === "S05" && confirmedSave
    ...
    : initialSearch.get("companion_context") === "non_semantic"
      ? "non_semantic"
      : undefined;
  const s02SceneOwnsDecoration = activeScreen === "S02" && resolveSceneGate(import.meta.env.VITE_SK7_SCENE_MODE) === "review";
  const s02CompanionSpecies = s02SceneOwnsDecoration && companionMode !== "off"
