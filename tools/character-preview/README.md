...
현재 **7종·49개 고유 동작**이 선언한 로컬 기술 QA 범위를 통과했다. 곰 v007,
토끼 v002, 강아지 v001, 고양이 v002의 이전 결과를 보존하고 레서판다 v003,
수달 v003, 카피바라 v002를 새 입력·출력에서 추가 검증했다. 새 세 후보의 실제
viewer 실행은 `2033c366e742645cb31f642b7b4a8a44fc7e1257`, 생성 코드는
`6a617adff19252d6883db869c89c2fdfdd8d30c1`이며 이 문서 반영 커밋과 구분한다.
원본 열기·표준/경량 전체 loop·고정 바닥·영상 검사와 근거는
[현재 확인된 범위](../../docs/character-preview-verification.md#현재-확인된-범위)와
[새 세 후보 기록](../../docs/character-preview-verification.md#새-세-후보-실행-기록과-한계)에 있다.
고슴도치·펭귄·물범·여우·다람쥐는 아직 이 수량에 포함하지 않는다. 모든 후보의
사람 디자인 승인은 대기이며, 전 프레임 충돌·물리 접지·제품 출시 승인이 아니다.
레서판다의 작은 꼬리 면에 남은 normal 진단도 해당 기록에서 그대로 구분한다.
