...
| R-08 | Liveness and dependency readiness endpoints are planned but absent. | P0 | No `/live` or `/ready` route is registered. | Add minimal non-sensitive liveness and readiness endpoints with tests. | Healthy and dependency-unready responses are independently verified. |
