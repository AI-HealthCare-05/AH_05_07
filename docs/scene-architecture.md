...
- SceneRuntimeBoundary: recipe-visit failure ownership. Motion-tier changes reset readiness but do not retry a failed recipe. SceneTierBoundary owns visibility, activation, timeout and the single poster fallback; the lazy error boundary reports failure without rendering a duplicate poster.
