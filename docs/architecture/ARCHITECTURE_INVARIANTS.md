...
| MODEL-02 | Feature order and feature semantics are frozen; approved artifact SHA-256 is `d0f3bc407edae83db0852e9b393831b02cc5420a49fbc447d8d108f99c69ed84`. | W inference boundary | Artifact verification and contract tests | ENFORCED in source. |
...
| MODEL-06 | Product applicability is 19+; 80+ requires an applicability caution; semantics are non-diagnostic. | W API contract; M copy | Input/response tests and browser verification | ENFORCED in source; runtime evidence is operator-verified. |
