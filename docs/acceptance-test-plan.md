...
1. **AC-01, AC-04, AC-06, and AC-08** — extend the signed-in browser harness with current-check-in edit/delete and storage-failure scenarios already represented by the product contract; do not infer completion for email-link or new-tab coverage.
