...
1. **AC-01, AC-04, AC-06, and AC-08** — extend the signed-in browser harness with current-check-in edit/delete, duplicate, timeout, empty, stale, and failure scenarios already represented by the product contract.
