...
1. **AC-01, AC-04, AC-06, and AC-08** — retain signed-in browser evidence and add a separately bounded timeout scenario; do not infer completion for email-link or new-tab coverage.
