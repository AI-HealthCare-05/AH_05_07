...
1. **AC-01, AC-04, AC-06, and AC-08** — retain the signed-in browser harness for current-check-in edit/delete and add a separately bounded storage-failure scenario; do not infer completion for email-link or new-tab coverage.
