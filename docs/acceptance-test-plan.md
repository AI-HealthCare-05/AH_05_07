...
1. **AC-01, AC-04, AC-06, and AC-08** — automate the signed-in browser recovery, validation, current-check-in edit/delete, duplicate, timeout, empty, stale, and failure scenarios already represented by the product contract.
...
3. **AC-09 and AC-10** — complete the representative production-log review and the documented clean-environment deployment rehearsal.
