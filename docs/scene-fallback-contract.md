...
The S05 review migration retains the current CSS fallback and confirmed-save message/CTA outside its decorative failure boundary. Tier 0 does not manufacture a second confirmation.
