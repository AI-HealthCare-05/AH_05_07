...
별도 주둥이·콧구멍과 외부 꼬리 제외를 구현했다. 기존 후보는 보존하며 추가
전체/경량 렌더를 수행하지 않았다. 수정 자산의 실제 검토와 아직 미제작인
다섯 종의 제작을 이어간다. 소스 또는 합성 검사 통과를 자산 품질 승인으로 세지 않는다.

G4 소스 `d5e1b4c73694c4af68f6928844d78422c41e37ca`에서 합성 검사 73개와
