...
제출 검토본 제작 시점에도 O2 승인·행 생성·대기는 시작하지 않았다. 2026-09-06에
새 행을 만든다고 가정해도 자연 만료는 가장 빨라야10월6일이어서 기존9월21일 제출
일정 이전에 완료할 수 없다. 실제 expires_at·purge 전 관찰 창은 별도 확정해야 한다.
일정 변경 또는 별도 환경 근거의 수용 여부는 외부 판단이며, 수용하더라도 운영
자연 만료 검증이 완료되었다고 기록하지 않는다.
