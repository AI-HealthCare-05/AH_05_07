...
3. Finish physical-device acceptance: Android Wi-Fi/cellular, GPU/peak-memory/FPS, TalkBack audible/Touch Explorer behavior and switch access; iPhone/iPad Safari realtime 3D, network/GPU/peak-memory/FPS, reduced motion and any remaining input methods; then review the recorded Android long-task observations against release criteria.
