...
| Android Chrome SM-A528N / Android 14 / Chrome 152 | PARTIAL: local-preview S02/S10/S05 behavior, selected transfer/cache and context lifecycle passed; network, GPU/memory/FPS and TalkBack remain unmeasured |
...
3. Finish physical-device acceptance: Android Wi-Fi/cellular, GPU/peak-memory/FPS and TalkBack; iPhone/iPad Safari realtime 3D, network/GPU/peak-memory/FPS, reduced motion and any remaining input methods; then review the recorded Android long-task observations against release criteria.
