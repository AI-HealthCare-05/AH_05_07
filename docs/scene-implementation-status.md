...
| Physical Safari / VoiceOver, GPU/memory/FPS | NOT MEASURED |
...
3. Finish physical-device acceptance: Android Wi-Fi/cellular, GPU/peak-memory/FPS and TalkBack; iPhone/iPad Safari and VoiceOver; then review the recorded Android long-task observations against release criteria.
