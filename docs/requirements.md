...
| FR-07 | P0 | Partial | User | Read, edit, delete, and export only records owned by the signed-in user. | Web connects BP read, edit, explicit-confirmation delete, and recent-seven-day JSON export; challenge-record edit and delete remain unavailable. |
